    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-grid demo-content">
          ...
          <?php
          $query = $conn-> query("SELECT DISTINCT id_transaksi, total_transaksi, tanggal_transaksi, ket FROM transaksi JOIN transaksi_penyewaan using(id_transaksi) WHERE username='$user'");
          while ($data = $query->fetch_assoc()) {
            # code...
            if ($data['ket'] == "Belum Melakukan Pembayaran") {
              # code...
              ?>
              <h4 class="mdl-cell--12-col mdl-cell">Tagihan Anda <?php echo $_SESSION["pelanggan"]["nama"] ?> (Belum dibayar)</h4>
              <h6 class="mdl-cell">Segera lakukan pembayaran tagihan penyewaan anda.</h6>
              <div class="dataTables_wrapper">
                <table style="width: 100%;" class="mdl-data-table" id="example">
                  <thead>
                    <tr>
                      <td>Id Transaksi</td>
                      <td>Tgl Transaksi</td>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="nota.php?id=<?= $data['id_transaksi']; ?>" class="mdl-button mdl-js-button mdl-button--raised mdl-color--red-700 mdl-js-ripple-effect mdl-button--colored mdl-color-text--white">Detail</a>
                      </td>
                    </tr>
                  </tbody>
            ...
            # code...
              ?>
              <h4 class="mdl-cell--12-col mdl-cell">Tagihan Anda <?php echo $_SESSION["pelanggan"]["nama"] ?> (Dalam Pengecekan)</h4>
              <h6 class="mdl-cell">Segera lakukan pembayaran tagihan penyewaan anda.</h6>
              <div class="dataTables_wrapper">
                <table style="width: 100%;" class="mdl-data-table" id="example">
                  <thead>
            ...
            ?>
            <h4 class="mdl-cell--12-col mdl-cell">Tagihan Anda <?php echo $_SESSION["pelanggan"]["nama"] ?> (Selesai)</h4>
              <h6 class="mdl-cell">Segera lakukan pembayaran tagihan penyewaan anda.</h6>
              <div class="dataTables_wrapper">
                <table style="width: 100%;" class="mdl-data-table" id="example">
                  <thead>
